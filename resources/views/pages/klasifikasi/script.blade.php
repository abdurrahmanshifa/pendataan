<script>
    ...
    $("[name=form_data]").on('submit', function(e) {
        ...
        if(save_method == 'add'){
            var url = '{{route("klasifikasi.simpan")}}';
        }else{
            var url = '{{route("klasifikasi.ubah")}}';
        }
    ...
    $(".tambah").click(function(){
        ...
        $('[name="keterangan"]').val('Bangunan Kesehatan').change();
    });
    ...
    function ubah(id)
    {
        ...
        $.ajax({
            url : "{{url('master/klasifikasi/data/')}}"+"/"+id,
            type: "GET",
            dataType: "JSON",
            success: function(data){
                ...
                $('[name="keterangan"]').val(data.keterangan).change();
            },
    ...
    function hapus(id)
    {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                        url : "{{url('master/klasifikasi/hapus/')}}"+"/"+id,
                        type: "POST",
                        data : {
                            '_method'   : 'delete',
                            '_token'    : '{{ csrf_token() }}',
